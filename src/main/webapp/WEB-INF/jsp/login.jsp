            ...
            <div id="login_form">
                ...
                <form method="post" action="/login" id="login" name="login">
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary" id="check_passwd" name="check_passwd">
                            <spring:message code="login"/></button>
                    </div>
                </form>
                <div class="float-left">
                    <spring:message code="havntAcc"/> <a id="register_link" class="font-weight-light" role="button"
                                                         data-toggle="modal"
                                                         data-target="#registerWindow">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <form name="registerForm" action="${pageContext.request.contextPath}/"
...
<script>
    ...
    function doRegistration() {
        ...
        $.ajax({
            type: 'POST',
            url: '/checks/password',
            data: {user_login : userEmail, user_pass: userPas},
